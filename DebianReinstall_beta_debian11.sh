...
urldata=$(rm -rf /tmp/url.tmp && curl -o /tmp/url.tmp 'https://us.images.linuxcontainers.org/images/debian/bullseye/amd64/cloud/?C=M;O=D' && grep -o 2.......[\_]..[\:].. /tmp/url.tmp | head -n 1)
IMGURL=https://us.images.linuxcontainers.org/images/debian/bullseye/amd64/cloud/${urldata}/rootfs.tar.xz
