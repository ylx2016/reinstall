...
IMGURL=https://cf-image.ylx.workers.dev/images/debian/bullseye/amd64/stretch/${urldata}/rootfs.tar.xz
#IMGURL='https://github.com/debuerreotype/docker-debian-artifacts/raw/dist-amd64/stretch/rootfs.tar.xz'
CN_IMGURL='https://raw.sevencdn.com/debuerreotype/docker-debian-artifacts/dist-amd64/stretch/rootfs.tar.xz'
