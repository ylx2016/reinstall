...
urldata=$(rm -rf /tmp/url.tmp && curl -o /tmp/url.tmp 'https://cf-image.ylx.workers.dev/images/debian/stretch/amd64/cloud/?C=M;O=D' && grep -o 2.......[\_]..[\:].. /tmp/url.tmp | head -n 1)
IMGURL=https://cf-image.ylx.workers.dev/images/debian/stretch/amd64/cloud/${urldata}/rootfs.tar.xz
#IMGURL='https://github.com/debuerreotype/docker-debian-artifacts/raw/dist-amd64/stretch/rootfs.tar.xz'
CN_IMGURL=https://mirrors.tuna.tsinghua.edu.cn/lxc-images/images/debian/stretch/amd64/cloud/${urldata}/rootfs.tar.xz
