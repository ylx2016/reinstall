...
IMGURL=https://cf-image.ylx.workers.dev/images/debian/bullseye/amd64/buster/cloud/${urldata}/rootfs.tar.xz
#IMGURL='https://github.com/debuerreotype/docker-debian-artifacts/raw/dist-amd64/buster/rootfs.tar.xz'
CN_IMGURL=https://mirrors.tuna.tsinghua.edu.cn/lxc-images/images/debian/bullseye/amd64/buster/cloud/${urldata}/rootfs.tar.xz
