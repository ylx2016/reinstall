...
CN_IMGURL='https://raw.sevencdn.com/oracle/container-images/dist-amd64/7/oraclelinux-7-amd64-rootfs.tar.xz'
...
INIT_OS(){
    ...
    yum makecache fast
    yum install -y grub2 grub2-common grub2-tools grub2-tools-extra grub2-tools-minimal grubby util-linux dhclient openssh-server passwd wget nano kernel htop
