...
INIT_OS(){
    ...
    apt-get update
	apt-get install -y systemd openssh-server passwd wget nano linux-image-amd64 htop net-tools isc-dhcp-client ifplugd ifupdown ifmetric ifscheme ethtool guessnet fdisk coreutils curl unzip socat crontabs jq binutils ping6 qrencode nginx semanage sudo
