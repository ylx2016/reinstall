...
# Default Password: blog.ylx.me Port 52890, Change it after installation ! By dansnow and YLX

urldata=$(rm -rf /tmp/url.tmp && curl -o /tmp/url.tmp 'https://cf-image.ylx.workers.dev/images/ubuntu/bionic/amd64/cloud/?C=M;O=D' && grep -o 2.......[\_]..[\:].. /tmp/url.tmp | head -n 1)
IMGURL=https://cf-image.ylx.workers.dev/images/ubuntu/bionic/amd64/cloud/${urldata}/rootfs.tar.xz
...
CN_IMGURL=https://mirrors.tuna.tsinghua.edu.cn/lxc-images/images/ubuntu/bionic/amd64/cloud/${urldata}/rootfs.tar.xz
