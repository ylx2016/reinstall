...
bit=$(uname -m)
if [[ ${bit} == "x86_64" ]]; then
	urldata=$(rm -rf /tmp/url.tmp && curl -o /tmp/url.tmp 'https://cf-image.ylx.workers.dev/images/debian/trixie/amd64/cloud/?C=M;O=D' && grep -o 2.......[\_]..[\:].. /tmp/url.tmp | head -n 1)
	IMGURL=https://cf-image.ylx.workers.dev/images/debian/trixie/amd64/cloud/${urldata}/rootfs.tar.xz
	#IMGURL='https://github.com/debuerreotype/docker-debian-artifacts/raw/dist-amd64/trixie/rootfs.tar.xz'
	CN_IMGURL=https://mirrors.tuna.tsinghua.edu.cn/lxc-images/images/debian/trixie/amd64/cloud/${urldata}/rootfs.tar.xz
	...
	urldata=$(rm -rf /tmp/url.tmp && curl -o /tmp/url.tmp 'https://cf-image.ylx.workers.dev/images/debian/trixie/arm64/cloud/?C=M;O=D' && grep -o 2.......[\_]..[\:].. /tmp/url.tmp | head -n 1)
	IMGURL=https://cf-image.ylx.workers.dev/images/debian/trixie/arm64/cloud/${urldata}/rootfs.tar.xz
	#IMGURL='https://github.com/debuerreotype/docker-debian-artifacts/raw/dist-amd64/trixie/rootfs.tar.xz'
	CN_IMGURL=https://mirrors.tuna.tsinghua.edu.cn/lxc-images/images/debian/trixie/arm64/cloud/${urldata}/rootfs.tar.xz
	#BUSYBOX='https://busybox.net/downloads/binaries/1.31.0-defconfig-multiarch-musl/busybox-x86_64'
